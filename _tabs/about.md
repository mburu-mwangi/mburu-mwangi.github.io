...
- Real-world system uptime monitoring
- Ticket analytics & operational intelligence
  
### Cyber Security Analyst
**Core Competancies**
- Network & Infrastructure Pentesting: Network scanning & enumeration, SMB exploitation
- Web Application Pentesting: OWASP Top 10, File upload vulnerabilities, Authentication/authorization bypass
- Linux & System Administration

I am particularly interested in applying data science to:
- Threat detection  
- Fraud analytics  
